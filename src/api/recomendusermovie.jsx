...
export const getRecomendedMovie = async (page = 1) => {
  const { data } = await axios(
    `https://api.themoviedb.org/3/discover/movie?api_key=f027fe75601755f162912a55c1ba85ad&with_genres=53&page=${page}`
  );
